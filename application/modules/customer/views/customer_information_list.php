                    ...
                    <tr>
                        ...
                        if ($user_type == 'admin') {
                            ...
                            <td>
							  ...
							  <a title="Print"
                                   href="<?php echo base_url() ?>customer/CustomerController/notification_status_change/<?php echo $user->insurence_data_id ?>" class="btn btn-danger">
                               Not Interested
                                </a>
                                ...
                                <a title="edit"
                                   href="<?php echo base_url() ?>notification-edit/<?php echo $user->insurence_data_id ?>"
